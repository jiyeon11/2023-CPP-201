...
user.name=이지연
user.email=leejiyeon415@gmail.com
...
user.name=leejiyeon
user.email=s2230@e-mirim.hs.kr
remote.origin.url=https://github.com/jiyeon11/2023-CPP-201.git
remote.origin.fetch=+refs/heads/*:refs/remotes/origin/*
remote.origin.pushurl=https://github.com/jiyeon11/2023-CPP-201.git
